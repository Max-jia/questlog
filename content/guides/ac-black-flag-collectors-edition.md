...
gameVersion: "1.0"
tldr:
  - "Collector's Edition includes the Deluxe Edition content plus physical items. Redeem codes in the Ubisoft Connect launcher or console store."
  - "Deluxe Edition adds bonus missions, ship cosmetics, and weapon skins. Redeem codes under 'Activate a Key' in Ubisoft Connect."
  - "Standard Edition is $59.99. Deluxe is $69.99. Collector's Edition varies by region."
tags:
  - Collector's Edition
  - Codes
  - Redeem
...
- Base game
- Bonus mission: "The Lost Treasures of Captain Morgan"
- Jackdaw cosmetics: Golden Age sails and figurehead
- Edward Kenway outfit: Captain's Regalia
- 2 exclusive weapon skins

### Collector's Edition (varies)
- Everything in Deluxe Edition
- Physical steelbook case
- Artbook (60 pages)
- Official soundtrack (digital)
- Edward Kenway statue (26 cm)
- Collector's box
...
**On Steam:** Games → Activate a Product on Steam → enter the code. The bonus content downloads automatically.

**On Ubisoft Connect:** Open Ubisoft Connect → click your avatar → Activate a Key → enter the code. Content unlocks in-game after activation.

**On PS5/Xbox:** Go to the platform store → Redeem Code → enter the code. Content installs to your game.

If the bonus content does not appear in-game after redeeming, restart the game and check the Captain's Quarters on the Jackdaw for cosmetics and the map for bonus missions.
