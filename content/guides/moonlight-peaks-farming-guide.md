---
title: "Moonlight Peaks Farming Guide: Best Crops, Livestock & Layout Strategy"
excerpt: "Complete farming guide for Moonlight Peaks. Crop profitability rankings by season, magical livestock care, greenhouse unlock requirements, and the optimal farm layout for maximum yield."
...
sources:
  ...
  - name: "Siliconera: Moonlight Peaks"
...
|------|:---:|:---:|:---:|:---:|
| Nightshade | 2 | 14 | 45G | 22.5G |
| Bloodmoss | 3 | 9 | 80G | 26.7G |
| Ghost Pepper | 4 | 7 | 140G | 35G |
| Crimson Carrot | 3 | 9 | 65G | 21.7G |
| Shadow Lettuce | 2 | 14 | 35G | 17.5G |

**Best spring crop**: Ghost Pepper. Highest profit per night and unlocks the Pepper Spray potion (craftable defense item).

### Summer (28 Nights)

| Crop | Nights | Harvests per Season | Sell Price | Profit per Night |
|------|:---:|:---:|:---:|:---:|
| Sunfruit | 5 | 5 | 180G | 36G |
| Infernal Tomato | 3 | 9 | 90G | 30G |
| Batwing Bean | 4 | 7 | 110G | 27.5G |
| Moonlit Melon | 7 | 4 | 280G | 40G |
| Cursed Corn | 4 | 7 | 100G | 25G |

**Best summer crop**: Moonlit Melon. Highest seasonal profit, but the 7-night growth cycle means you must protect it (scarecrows prevent bat raids).

### Fall (28 Nights)

| Crop | Nights | Harvests per Season | Sell Price | Profit per Night |
|------|:---:|:---:|:---:|:---:|
| Pumpkin | 8 | 3 | 250G | 31.3G |
| Wolfsbane | 4 | 7 | 130G | 32.5G |
| Shadow Corn | 5 | 5 | 160G | 32G |
| Witch's Thistle | 3 | 9 | 75G | 25G |
| Vampire Vine | 6 | 4 | 200G | 33.3G |
...
| Crop | Nights | Harvests per Season | Sell Price | Profit per Night |
|------|:---:|:---:|:---:|:---:|
| Frostberry | 5 | 5 | 320G | 64G |
| Icecap Mushroom | 3 | 9 | 150G | 50G |
| Northern Lights Herb | 4 | 7 | 210G | 52.5G |

**Frostberries are the best crop in the game, period.**
...
| Animal | Buy Price | Product | Rate | Sell Price | Special |
|--------|:---:|------|:---:|:---:|------|
| Draculamb | 1,500G | Blood Wool | Every 3 nights | 120G | Used for Vampire Cloak (defense +20%) |
| Hellkitten | 2,000G | Infernal Milk | Daily | 90G | Used for Lava Latte (energy +75%) |
...
Your farm starts as a 12×12 grid and expands to 24×24 at maximum upgrade. The layout below is optimized for the time constraint (you have 8.5 hours per night):

```
[HOUSE+COFFIN] ---- [FARMING GRID (crops)] ----
                                  |
[BARN (animals)] - [POTION STATION + STORAGE]
                                  |
                    [GREENHOUSE (winter crops)]
```

**Key principles**:
- Coffin in the center. You never walk more than 5 seconds to safety.
- Potion station adjacent to farming grid. You craft Blood Flasks while standing in your crop field.
- Storage next to the shipping bin. Harvest → store → ship is one fluid motion without backtracking.
- Barn at the edge. Animals are visited once per night (feed + collect). They do not need to be central.
