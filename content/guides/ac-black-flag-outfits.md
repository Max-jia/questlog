...
gameVersion: "1.0"
tldr:
  - "The Mayan Armor deflects bullets. Collect all Mayan Stelae to unlock it. This is the best outfit in the game."
  - "The Templar Armor reduces melee damage. Complete the Templar Hunt missions."
  - "Most outfits are cosmetic only. Only the Mayan and Templar armors have gameplay effects."
tags:
  - Outfits
  - Cosmetics
  - Reference
...
Complete all Templar Hunt missions. Reduces melee damage. Less useful than Mayan Armor but worth getting for the damage reduction in close combat.

---

### Cosmetic outfits

The rest are cosmetic. Hunter Outfit. Pirate Captain. Edward's default robes. They look different but play the same. Do not grind for outfits unless you care about style.
